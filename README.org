...
| [[file:README.org::*shell / completion][shell / completion]]          | [[file:README.org::*popper][popper]]    | [[file:README.org::*recentf-open][recentf-open]]            |
| [[file:README.org::*capf-autosuggest][capf-autosuggest]]            | [[file:README.org::*kurecolor][kurecolor]] | [[file:README.org::*rainbow-mode][rainbow-mode]]            |
| [[file:README.org::*Ada][Ada]]                         |           | [[file:README.org::*visual-fill-column-mode][visual-fill-column-mode]] |
...
Yes, adapted to using =abbrev-mode=, the syntax for the =abbrev_defs= is very similar to tempel congiguration files so easy to adapt.
