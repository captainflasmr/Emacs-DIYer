...
| TODO               | DOING                        | DONE                        |
|--------------------+------------------------------+-----------------------------|
| htmlize            | embark                       | minibuffer completion       |
| shell / completion | popper                       | ace-window                  |
| capf-autosuggest   | pandoc md to org conversion  | recentf-open                |
| Ada                | completion - corfu / company | rainbow-mode                |
