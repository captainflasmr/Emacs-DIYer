...
| TODO               | DOING                        | DONE                        |
|--------------------+------------------------------+-----------------------------|
| [[file:README.org::*htmlize][htmlize]]            | [[file:README.org::*embark][embark]]                       | [[file:README.org::*minibuffer completion][minibuffer completion]]       |
| [[file:README.org::*shell / completion][shell / completion]] | [[file:README.org::*popper][popper]]                       | [[file:README.org::*ace-window][ace-window]]                  |
| [[file:README.org::*capf-autosuggest][capf-autosuggest]]   | [[file:README.org::*pandoc md to org conversion][pandoc md to org conversion]]  | [[file:README.org::*recentf-open][recentf-open]]                |
| [[file:README.org::*Ada][Ada]]                | [[file:README.org::*completion - corfu / company][completion - corfu / company]] | [[file:README.org::*rainbow-mode][rainbow-mode]]                |
|                    |                              | [[file:README.org::*visual-fill-column-mode][visual-fill-column-mode]]     |
|                    |                              | [[file:README.org::*find-name-dired][find-name-dired]]             |
|                    |                              | [[file:README.org::*magit][magit]]                       |
|                    |                              | [[file:README.org::*tempel][tempel]]                      |
|                    |                              | [[file:README.org::*image-dired][image-dired]]                 |
|                    |                              | [[file:README.org::*selected-window-accent-mode][selected-window-accent-mode]] |
|                    |                              | [[file:README.org::*deadgrep][deadgrep]]                    |
|                    |                              | [[file:README.org::*jinx / powerthesaurus][jinx / powerthesaurus]]       |
